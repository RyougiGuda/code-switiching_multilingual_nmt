...
def main():
    ...
    code_switched_path = code_switched_path = "/home/ryougiguda/Projects/multilingual_nmt/data/bleu_single_pair/data_code_switching/code_switching" + str(num) + "/"
#path of code_switched data
    ...
    if os.path.exists(corpus_path+"test."+lang_pairs+"."+src):
        print(corpus_path+lang_pairs+"."+src)
        with open(corpus_path+"test."+lang_pairs+"."+src, "r") as src_corpus, \
             open(corpus_path+"test."+lang_pairs+"."+tgt, "r") as tgt_corpus, \
             open(code_switched_path+lang_pairs+"."+src, "w") as src_switched:
            print(code_switched_path)
